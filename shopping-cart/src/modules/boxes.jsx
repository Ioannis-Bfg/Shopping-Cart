export default function Boxes() {
  ...
  const handleMouseEnter = (event) => {
    ...
    ids.forEach((id) => {
      if (id !== currentDiv.id) {
        ...
        otherDiv.style.backgroundColor = "rgb(229 231 235)";
  ...
  return (
    <>
      <div className="flex h-[700px] justify-center items-center gap-4 px-[20rem] py-20">
        <div
          id="div-1"
          className="bg-gray-100 h-full shadow-md bg-[url('/certified.png)] text-black w-full rounded-lg flex-1 overflow-hidden py-40 transition-all duration-300 ease-out  flex flex-col justify-center items-center gap-4"
          onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}
        >
          <div className="flex flex-col gap-8 justify-center items-center px-20 ">
            <div className="flex flex-col  justify-center items-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="truncate text-sm text-current">
                  Leica, Fuji, Canon
                </p>
              </div>
            </div>
            ...
            >
              ...
              behind our products and offer a 100% satisfaction guarantee. If
              for any reason you are not satisfied, we will work with you to
              resolve the issue.
            </div>
          </div>
        </div>
        ...
        >
          <div className="flex flex-col gap-8 justify-center items-center px-20 ">
            <div className="flex flex-col  justify-center items-center">
              <svg
                className="fill-current size-20 min-w-10 w-16"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
            ...
            >
              ...
              free. Order now and start creating memories that will last a
              lifetime.
            </div>
          </div>
        </div>
