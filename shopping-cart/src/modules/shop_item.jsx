export default function ShopItem({ imageUrl, isNew, isSale }) {
  return (
    <div className="container shadow-lg rounded-lg bg-white h-[400px] group grid grid-rows-10 ">
        ...
        <div className=" absolute z-10 left-3 top-3 flex items-center">
          {isNew && (
            <svg
              ...
              className="size-12 fill-sky-500"
              viewBox="0 0 24 24"
            >
              <title>new-box</title>
          ...
          {isSale && (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              className="size-10  fill-sky-700 "
            >
              <title>sale</title>
      ...
      <div className="row-span-3 mx-auto my-auto flex items-center py-2 justify-between px-8 w-80">
